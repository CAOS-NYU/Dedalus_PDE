...
Lx, Ly, Lz = 8, 8, 1 #domain size
Nx, NY, Nz = 256, 256 32 #number of spectral components in each direction
...
compute_mesh = (16,16) #mesh for parallel computation. Product must match number of CPU
...
dist = d3.Distributor(coords, mesh = compute_mesh, dtype=dtype)
...
N2z = dist.Field(name='N2z', bases=(xbasis,ybasis,zbasis))
N2z['g']= N2 * z
